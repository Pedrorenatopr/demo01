...
import com.example.demo.domain.consulta.AgendaDeConsultas;
import com.example.demo.domain.consulta.DadosAgendamentoConsulta;
import com.example.demo.domain.consulta.DadosDetalhamentoConsulta;
...
class ConsultaControllerTest {
    ...
    @Test
    @DisplayName("Deveria devolver codigo http 200 quando informaçoes estao validas")
    @WithMockUser
    void agendar_cenario2() throws Exception {
        var data = LocalDateTime.now().plusHours(1);
        var especialidade = Especialidade.GESTOR;
